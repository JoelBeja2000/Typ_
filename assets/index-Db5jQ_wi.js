...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Aa,depthTest:!1,depthWrite:!1})}function l1(r,t,i){const s=new Float32Array(Bs),l=new re(0,1,0);return new Ki({name:"SphericalGaussianBlur",defines:{n:Bs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:Aa,depthTest:!1,depthWrite:!1})}function d_(){return new Ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:Aa,depthTest:!1,depthWrite:!1})}function h_(){return new Ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:Aa,depthTest:!1,depthWrite:!1})}function Yc(){return`
