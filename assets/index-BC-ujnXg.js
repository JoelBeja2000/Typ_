 ...
 */var E0;function Cy(){if(E0)return zo;E0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,c){var d=null;if(c!==void 0&&(d=""+c),l.key!==void 0&&(d=""+l.key),"key"in l){c={};for(var h in l)h!=="key"&&(c[h]=l[h])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:d,ref:l!==void 0?l:null,props:c}}return zo.Fragment=t,zo.jsx=i,zo.jsxs=i,zo}var T0;function Ry(){return T0||(T0=1,ed.exports=Cy()),ed.exports}var B=Ry(),td={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ta,depthTest:!1,depthWrite:!1})}function f_(){return new Zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:Ta,depthTest:!1,depthWrite:!1})}function d_(){return new Zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
...
`)}const hT={[H_]:"Linear",[G_]:"Reinhard",[V_]:"Cineon",[k_]:"ACESFilmic",[q_]:"AgX",[j_]:"Neutral",[X_]:"Custom"};function pT(r,t){const i=hT[t];return i===void 0?(lt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Lc=new re;function mT(){Ut.getLuminanceCoefficients(Lc);const r=Lc.x.toFixed(4),t=Lc.y.toFixed(4),i=Lc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+y);const N=D+b+d,U=D+y+h,L=x_(l,l.VERTEX_SHADER,N),O=x_(l,l.FRAGMENT_SHADER,U);l.attachShader(A,L),l.attachShader(A,O),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function F(X){if(r.debug.checkShaderErrors){const J=l.getProgramInfoLog(A)||"",K=l.getShaderInfoLog(L)||"",ce=l.getShaderInfoLog(O)||"",he=J.trim(),I=K.trim(),k=ce.trim();let te=!0,Me=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(te=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,L,O);else{const ye=S_(l,L,"vertex"),z=S_(l,O,"fragment");Ft("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
